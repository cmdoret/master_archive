...
```{r up_down_PI, dependson='RAD_PI', cache=T, cache.lazy=F, echo=F, fig.cap="\\label{fig:up_down}PI values of the local (10kb) neighbourhood of each significant RADseq SNP compared to upstream and downstream regions. Regions belonging to a SNP are linked by a segment."}
