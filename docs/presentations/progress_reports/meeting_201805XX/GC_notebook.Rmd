...
wgs_GC <- wgs_nuc %>% mutate_at(.vars = vars(starts_with("X")), .funs = ifelse(. %in% c("G","C"), 1, 0))
...
plot(LG1$N_original[order(LG1$N_original)], 
     ...
     main="Genome vs linkage map marker orders for LG1")
```
